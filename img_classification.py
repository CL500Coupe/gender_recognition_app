...
import tensorflow as tf
import tensorflow_hub as hub #co to kurwa jest xD
...
def classification_machine(image1):
	...
	shape = ((180,180,3))#input shape #can't really change that as I build model like this
	...
	#test_image = test_image/255.0  WHY THIS AINT WORKING?
